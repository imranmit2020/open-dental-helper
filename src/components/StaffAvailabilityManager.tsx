...
import { Clock, MapPin, Plus, Edit, Trash2, Users } from "lucide-react";
...
export function StaffAvailabilityManager({ staffId }: StaffAvailabilityManagerProps) {
  const { availability, loading, deleteAvailability } = useStaffAvailability(staffId);
  ...
  const handleDelete = async (id: string) => {
    if (window.confirm('Are you sure you want to delete this staff availability schedule?')) {
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold flex items-center">
            ...
            Staff Multi-Clinic Availability
          </h3>
          <p className="text-sm text-muted-foreground">
            Manage staff schedules across different clinics
          </p>
        </div>
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent className="max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Set staff availability for a specific clinic and day
              </DialogDescription>
            </DialogHeader>
      ...
      {Object.keys(clinicGroups).length === 0 ? (
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">No staff schedules set</h3>
            <p className="text-muted-foreground mb-4">
              Start by adding availability schedules for staff across different clinics
            </p>
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              <DialogTrigger asChild>
                <Button onClick={() => setEditingAvailability(null)}>
